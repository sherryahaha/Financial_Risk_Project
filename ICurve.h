...
typedef std::shared_ptr<const ICurveFXSpot> ptr_spot_curve_t;
typedef std::shared_ptr<const ICurveFXForward> ptr_forward_curve_t;
...
{
    virtual double forward_price(const Date &t) const = 0;
};
